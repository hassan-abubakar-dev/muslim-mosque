...
import { getMosque, getMosques, registerMosque, getUserFollowedMosques, getMosqueCounts, getPendingMosques, verifiedMosque, getFollowedMosqueIds } from '../controllers/mosque.js';
...
router.get('/get-mosque/:mosqueId', optionalAuth, getMosque);  
...
router.get('/get-analysis', protectRoutes, authorize('superAdmin'), getMosqueCounts)
